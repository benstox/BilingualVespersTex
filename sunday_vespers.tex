...
\gregorioscore[a]{LatinVersion/NoctemQuietam.gtex}
...
%% DID UP TO HERE IN UPGRADING GREGORIO
...
{\noinitial
\includescore{EnglishVersion/Completorium/NoctemQuietam.tex}
...
\myaboveinitial{\Abar\ VIII G}
\includescore{EnglishVersion/Completorium/CompAnt-01.tex}
...
{\noinitial
\includescore{EnglishVersion/Completorium/CompFL1.tex}
...
{\noinitial
\includescore{EnglishVersion/Completorium/CompFL2.tex}
...
{\noinitial
\includescore{EnglishVersion/Completorium/CompFL3.tex}
...
{\noinitial
\includescore{EnglishVersion/Completorium/CompFL4.tex}
...
{\noinitial
\includescore{EnglishVersion/Completorium/CompAnt-02.tex}
...
\myaboveinitial{VIII}
\includescore{EnglishVersion/Completorium/TeLucisPAFeriis.tex}
...
\myaboveinitial{VIII}
\includescore{EnglishVersion/Completorium/TeLucisPADominicis.tex}
...
\myaboveinitial{VIII}
\includescore{EnglishVersion/Completorium/TeLucisPASimplex.tex}
...
\myaboveinitial{IV}
\includescore{EnglishVersion/Completorium/TeLucisPADuplex.tex}
...
\myaboveinitial{II}
\includescore{EnglishVersion/Completorium/TeLucisAdvent.tex}
...
\myaboveinitial{II}
\includescore{EnglishVersion/Completorium/TeLucisLent.tex}
...
\myaboveinitial{II}
\includescore{EnglishVersion/Completorium/TeLucisBMVCorpChrist.tex}
...
\myaboveinitial{VI}
\includescore{EnglishVersion/Completorium/CompRespPA.tex}
...
\myaboveinitial{IV}
\includescore{EnglishVersion/Completorium/CompRespAdvent.tex}
...
\myaboveinitial{IV}
\includescore{EnglishVersion/Completorium/CompRespLent.tex}
...
\myaboveinitial{III a}
\includescore{EnglishVersion/Completorium/CompNuncDimAnt-01.tex}
...
{\noinitial
\includescore{EnglishVersion/Completorium/CompNuncDimAnt-02.tex}
...
\myaboveinitial{II}
\includescore{EnglishVersion/Completorium/CompBenedicamus.tex}
