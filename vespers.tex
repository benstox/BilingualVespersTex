...
\textcolor{benred8}{\emph{A sign of reverence is made :}} Blessed be the \textbf{name} of \textbf{the} Lord, \gresixstar\ from henceforth \textbf{now} and for \textbf{e}ver.

From the rising of the sun unto the going \textbf{down} of \textbf{the} same, \gresixstar\ the name of the Lord is \textbf{worth}y \textbf{of} praise.

The Lord is high a\textbf{bove} all \textbf{na}tions; \gresixstar\ and his glory a\textbf{bove} the \textbf{hea}vens.

Who is as the Lord our God, who \textbf{dwel}leth \textbf{on} high: \gresixstar\ and looketh down on the low things in \textbf{hea}ven and \textbf{in} earth?

Raising up the \textbf{need}y \textbf{from} the earth, \gresixstar\ and lifting up the poor \textbf{out} of the \textbf{dung}hill:

That he may \textbf{place} him with \textbf{prin}ces, \gresixstar\ with the princes \textbf{of} his \textbf{peo}ple.

Who maketh a barren woman to \textbf{dwell} in \textbf{a} house, \gresixstar\ the joyful \textbf{moth}er of \textbf{child}ren.
