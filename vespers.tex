...
The Lord will send forth the sceptre of thy power \pipe\ out of Sion: \gresixstar\ rule thou in the \pipe\ midst of thy enemies.

With thee is the principality in the day of thy strength: in the \pipe\ brightness \underline{of the} saints: \gresixstar\ from the womb before the day star \pipe\ I begot thee.

The Lord hath sworn, and \pipe\ he will \underline{not re}pent: \gresixstar\ Thou art a priest for ever according to the order \pipe\ of Melchisedech.

The \pipe\ Lord at thy right hand \gresixstar\ hath broken kings in the \pipe\ \textbf{day} of his wrath.

He shall judge among nations, \pipe\ he shall fill ruins: \gresixstar\ he shall crush the heads in the \pipe\ land of many.

He shall drink of the \pipe\ torrent \underline{in the} way: \gresixstar\ therefore shall he \pipe\ \textbf{lift} up the head.

Glory be to the \pipe\ Father, and \underline{to the} Son, \gresixstar\ and to the \pipe\ Holy Spirit.
...
\textcolor{benred8}{\emph{A sign of reverence is made:}} Blessed be the \pipe\ \textbf{name} \underline{of the} Lord, \gresixstar\ from henceforth \pipe\ now \underline{and for} ever.

From the rising of the sun unto the going \pipe\ \textbf{down} \underline{of the} same, \gresixstar\ the name of the Lord is \pipe\ \textbf{worth}\underline{y of} praise.

The Lord is high a- \pipe\ bove all nations; \gresixstar\ and his glory a- \pipe\ bove the heavens.

Who is as the Lord our God, who \pipe\ \textbf{dwel}\underline{leth on} high: \gresixstar\ and looketh down on the low things in \pipe\ heaven \underline{and in} earth?

Raising up the \pipe\ needy \underline{from the} earth, \gresixstar\ and lifting up the \pipe\ poor \underline{out of the} dunghill:

That he may \pipe\ place \underline{him with} princes, \gresixstar\ with the \pipe\ prin\underline{ces of his} people.

Who maketh a barren woman to \pipe\ \textbf{dwell} \underline{in a} house, \gresixstar\ the joyful \pipe\ mo\underline{ther of} children.

Glory be to the \pipe\ Fa\underline{ther, and} \underline{to the} Son, \gresixstar\ and to the \pipe\ Holy Spirit.
